...
image:https://github.com/bonitasoft/bonita-openapi/workflows/Build/badge.svg[Actions Status, link=https://github.com/bonitasoft/bonita-openapi/actions?query=workflow%3ABuild]
...
We would love you to contribute, pull requests are welcome! Don't forget to sign our Contributor Licensing Agreements when opening a pull request.
